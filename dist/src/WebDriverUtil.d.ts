import { GetElementByDriver, SeleniumDriver, TargetDriver, TargetLocator, WdioDriver } from "./Types";
...
export declare const isUniqueLocator: (driver: TargetDriver, locator: TargetLocator) => Promise<boolean>;
